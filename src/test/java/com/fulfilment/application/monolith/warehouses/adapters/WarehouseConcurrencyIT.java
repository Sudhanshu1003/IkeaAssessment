...
public class WarehouseConcurrencyIT {
  ...
  public void testConcurrentReadsAreNonBlocking() throws InterruptedException {
    // Create a warehouse first in a separate transaction
    Warehouse warehouse = new Warehouse();
    ...
    warehouseRepository.create(warehouse);
    Warehouse created = warehouseRepository.findByBusinessUnitCode("READ-TEST-001");
    assertNotNull(created, "Warehouse should be created successfully before concurrent reads");
